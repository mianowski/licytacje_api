...
class Notice():
    def __init__(self, url):
        ...
        self.address = self.get_address(self.preview)
    ...
    def get_address(self):
        ...
        address = ""
        try:
            address = re.search(r"położone.*(?: przy )(.*),", self.preview.get_text(strip=True)).group(1)
        except:
            pass
        return address
...
if __name__=="__main__":
    ...
    print(re.search(r"położone.* przy (.*),", text_1).group(1))
